...
class SignUpFormAdmin extends StatefulWidget {
  ...
  _SignUpFormAdminState createState() => _SignUpFormAdminState();
}

class _SignUpFormAdminState extends State<SignUpFormAdmin> {
  ...
  _registrationAdmin() async {
   ...
   await AuthService().signInAdmin(context,_email, _password);
          // final authResult =
          //     await _firebaseService.signUpPerson(context, student);
